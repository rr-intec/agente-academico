"""Cliente Postgres async con pool (asyncpg).

Copia de la base probada de sofia-pro/app/adapters/postgres_client.py.
Apunta a la MISMA Supabase que Sofía/Panel (veic...).
"""
...
class PostgresAdapter:
    ...
    async def connect(self, min_size: int = 1, max_size: int = 5, command_timeout: float = 30.0) -> None:
